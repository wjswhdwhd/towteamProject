...
<body id= "body">
	<article id="content" class="cols-d">
		<div>
			<h1>이용약관</h1>
			<form id="terms_form" class="f" action="/member/join">
				<h4 class="scheme-g">개인정보 이용약관</h4>
				<textarea style="font-size: 1em;">1. 개인정보 수집에 대한 동의 
우리집고양이는 이용자의 개인정보보호방침 또는 이용약관의 내용에 대해 「동의합니다」버튼을 클릭할 수 있는 절차를 마련하여, 「동의합니다」버튼을 클릭하면 개인정보 수집에 대해 동의한 것으로 봅니다.
...
대부분의 서비스는 별도의 사용자 등록이 없이 언제든지 사용할 수 있습니다. 그러나 우리집고양이은 회원서비스를 통하여 이용자들에게 맞춤식 서비스를 비롯한 보다 더 향상된 양질의 서비스를 제공하기 위하여 다음과 같은 목적으로 이용자 개인의 정보를 수집하고 있습니다. 
우리집고양이는 이용자의 사전 동의 없이는 이용자의 개인 정보를 공개하지 않으며, 수집된 정보는 아래와 같이 이용하고 있습니다.
...
우리집고양이는 이용자들이 회원서비스를 이용하기 위해 회원으로 가입하실 때 서비스 제공을 위한 필수적인 정보들을 온라인상에서 입력 받고 있습니다. 
...
4. 개인정보의 보유기간 및 이용기간
이용자가 쇼핑몰 회원으로서 회사에 제공하는 서비스를 이용하는 동안 우리집고양이는 이용자들의 개인정보를 계속적으로 보유하며 서비스 제공 등을 위해 이용합니다. 다만, 개인정보취급방침 전체 내용 중 "8. 개인정보의 열람, 정정, 삭제 " 에서 설명한 절차와 방법에 따라 이용자 본인이 직접 삭제하거나 수정한 정보, 가입해지를 요청한 경우에는 재생할 수 없는 방법에 의하여 디스크에서 완전히 삭제하며 추후 열람이나 이용이 불가능한 상태로 처리됩니다.
...
그리고 상법, 전자상거래 등에서의 소비자보호에 관한 법률 등 관계법령의 규정에 의하여 보존할 필요가 있는 경우 우리집고양이는 관계법령에서 정한 일정한 기간 동안 회원정보를 보관합니다. 이 경우 우리집고양이는 보관하는 정보를 그 보관의 목적으로만 이용하며 보존기간은 아래와 같습니다.

- 계약 또는 청약철회 등에 관한 기록 : 5년
- 대금결제 및 재화 등의 공급에 관한 기록 : 5년
- 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년

우리집고양이는 귀중한 이용자의 개인정보를 안전하게 처리하며, 유출의 방지를 위하여 다음과 같은 방법을 통하여 개인정보를 파기합니다.
...
이 약관은 (주)서진에스앤디 회사(전자거래 사업자)가 운영하는 우리집고양이 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리•의무 및 책임사항을 규정함을 목적으로 합니다. 
※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」 


제2조(정의) 

① "몰"이란 (주)서진에스앤디 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다. 
...
우리집고양이는 서비스 향상을 위해서 귀하의 개인정보를 필요한 경우 동의 등 법률상의 요건을 구비하여 외부에 수집 • 취급 • 관리 등을 위탁하여 처리할 있으며, 제 3자에게 제공할 수 있습니다.
우리집고양이는 개인정보의 처리와 관련하여 아래와 같이 업무를 위탁하고 있으며, 관계 법령에 따라 위탁계약 시 개인정보가 안전하게 관리될 수 있도록 필요한 사항을 규정하고 있습니다. 또한 공유하는 정보는 당해 목적을 달성하기 위하여 필요한 최소한의 정보에 국한됩니다.
...
	위탁 대상자 : [네이버펫,폴스컴퍼니,이츠독,CM 코리아,코코펫,펀들,아페토,키튼박스,테라펫,가또블랑코,아트칩,퍼피아,펫모닝,
펫마트,캣츠월드,도그데이즈,퍼피아울렛,해피브런치,하나산,디제이도그,라바코,아로펫,펫츠뷰,힐링공방,한하루,
퍼피엔젤,핑크캣,키코유통,리터로봇,앰버펫,PS코리아,렛츠펫,두성,쿠나,퍼피엔느,이즈마인,피플앤컴퍼니,RGU]
	위탁업무 내용 : [주문상품의 배송]
